...
This website contains the _Warmaster Revolution_ xref:revolution:rules:index.adoc[rules] and xref:revolution:armies:index.adoc[army lists] for easier electronic browsing and searching.  Some text has been reorganised or slightly reworded, based on similar changes in later editions of _Warmaster_, but _there are no changes to the rules of the game_.  These edits are marked with dotted underlines or coloured borders, see xref:revolution:rules:editors-note.adoc#website-editors-note[this explanation] for details.  Many minor spelling and grammer improvements are not marked.
