...
make it impractical to see or shoot. See Diagram 27.1.
...
.Targets in sight | Targets out of sight | A stand can see if it is possible to draw a line of sight from its front edge to the target (shaded area).
image::the-shooting-phase/sight.png[]
...
image:::the-shooting-phase/empire-infantry.png[]
...
discussed in the Combat phase section (p.53).

image:::the-shooting-phase/wizard.png[]
...
image:::the-shooting-phase/boar-riders.png[]
...
to an evade move as described in the Movement section
(see p.24), but note that in the case of an evade, the unit
...
as a block. See Diagram 29.1.

#TODO diagram#

.Driving unit | Target unit | The infantry unit suffers three hits - enough to remove a stand and drive the unit back 3D6 cm. Rolls of 3, 4 and 5 give a 12 cm drive back as shown.
image:::the-shooting-phase/drive-back.png[]
...
the section on Confusion (p.55) for full rules.
...
image:::the-shooting-phase/chariot.png[]
...
image:::the-shooting-phase/skull.png[]
...
Note that some troops are allowed to shoot all round (eg,
...
removed, as shown in diagrams 31.1 and 31.2.
...
for the first round of fighting (see Combat results p.43).

.The Archers shoot as the Knights charge.
image:::the-shooting-phase/shooting-at-chargers.png[]
...
image:::the-shooting-phase/shooting-hits-carried-over.png[]
...
image::the-shooting-phase/charging.png[]
