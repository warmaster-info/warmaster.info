...
as described in the xref:generals-wizards-and-heroes.adoc[Generals & Heroes section].
...
magic, they may become *confused* (see the xref::the-shooting-phase.adoc[Shooting
...
xref::combat-phase.adoc#retreats[Combat phase – Retreats]).
...
See the xref::generals-wizards-and-heroes.adoc[Generals, Wizards and Heroes section].
