...
later>>. Stands can always move through characters
as described in the xref:characters.adoc[Generals & Heroes section].
...
// Wording tweaked with crossreference.
...
xref::combat.adoc#combat-engagement[Combat phase section] for rules for charges.
