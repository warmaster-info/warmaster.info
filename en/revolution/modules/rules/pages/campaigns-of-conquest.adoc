...
used to claim adjoining tiles as explained below. As a
...
It is good idea to place some objectives on the map to motivate
...
siege system. Because there are fortified places
...
battles on sea. The main task of fleets in a campaign is to
...
the old Man O’ War game or Armada. For this reason
