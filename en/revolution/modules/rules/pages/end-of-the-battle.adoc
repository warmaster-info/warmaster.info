...
image::end-of-the-battle/hero-dog.webp[width=583,height=529,role=decorative]
...
image::end-of-the-battle/knight-charge.webp[width=2013,height=2880,role=column-span]
