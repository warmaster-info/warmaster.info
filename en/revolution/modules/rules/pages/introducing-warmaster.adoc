...
image::introducing-warmaster/daemon.webp[width=417,height=483,role=decorative]
...
image::introducing-warmaster/zone-indicator.svg[width=1239,height=851,role=bo5a]
...
image::introducing-warmaster/wolves.webp[width=1945,height=1491,role=column-span]
