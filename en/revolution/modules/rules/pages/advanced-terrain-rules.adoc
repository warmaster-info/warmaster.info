...
xref:combat.adoc#defended[defended] in broken/marshy ground.
...
can enter it and stands count as xref:combat.adoc#defended[defended] when within.
...
units count as xref:combat.adoc#defended[defended] when within. All units
...
road through dense terrain still count as ‘xref:combat.adoc#defended[defended]’
