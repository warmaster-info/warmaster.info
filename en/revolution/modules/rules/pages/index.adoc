...
:page-role: -toc title-page page=2

image::index/warmaster-revolution.webp[Warmaster Revolution,width=2048,height=437]
...
image::index/zombies.webp[width=1927,height=1294]

Revolution edits and layout by Aleš Navrátil +
with help from Jan Zapatka.

Dedicated to the memory of Matthew Street +
May this book be your memorial
...
*_Version 2.1.0 (2026)._*

[.edit]
[IMPORTANT]
====
[.edit]#*This website includes edits to some text, marked like this.  See xref:editors-note.adoc#website-editors-note[Website editor’s note].*#
====
...
image:index/matthew-street.webp[width=143,height=62,float="right",role=nozoom]
Matthew Street †

[#cover-art]
== Cover art

_The Battle of Alexander at Issus_, Albrecht Altdorfer (1529)
...
Radomír Klabačka; Matthew Kozikowski; Chris Bennet; Matt Blissett
...
image::index/soldier.webp[width=2088,height=2989]
