...
image::siege-and-fortresses/moon.png[]
...
image::siege-and-fortresses/siege-tower.png[]
...
units do not have to for a battle line as in case of normal
...
image::siege-and-fortresses/tower-support.png[]

_When unit 1 attacks B, the Cannons A on the tower, and
units B and C may Stand and Shoot. Cannons D may not
Stand and Shoot as it is not the nearest unit on the wall
section (and it will not be in combat contact of course). B
and C will be in combat contact with 1._

_If unit 2 would have attacked first, Cannons A would
have had their Stand and Shoot against them but not
against unit 1 afterwards._
...
image::siege-and-fortresses/crossbowmen.png[]
...
image::siege-and-fortresses/elves-planning.png[]
...
image::siege-and-fortresses/defended-tower.png[]
...
image::siege-and-fortresses/dragon-ogre.png[]
...
image::siege-and-fortresses/siege.png[]
...
// TODO text
.A unit with a Siege Tower | The unit is arranged in column behind the Siege Tower
image::siege-and-fortresses/siege-tower-unit.png[]
...
// TODO text
.A unit with a Battering Ram | The unit is arranged in column behind the Battering Ram
image::siege-and-fortresses/battering-ram-unit.png[]
...
image::siege-and-fortresses/sow.png[]
...
image::siege-and-fortresses/mantlets.png[]
...
image::siege-and-fortresses/projectiles.png[]
...
image::siege-and-fortresses/tribock.png[]
...
image::siege-and-fortresses/bombard.png[]
...
image::siege-and-fortresses/mangonel.png[]
...
image::siege-and-fortresses/earthworks.png[]
...
attacking, as each 40x10mm section is effectively counted
...
image::siege-and-fortresses/log-rams.png[]
...
image::siege-and-fortresses/ladders.png[]
...
image::siege-and-fortresses/cannon-hill.png[]
...
image::siege-and-fortresses/elephant-rider.png[]

// TODO text
.TODO text
image::siege-and-fortresses/into-the-breach.png[]

=== The watchtower

The Watch Tower can be played on a 1.8×1.2m (6’x4’) table
...
// TODO text
.TODO text
image::siege-and-fortresses/the-watchtower.png[]
