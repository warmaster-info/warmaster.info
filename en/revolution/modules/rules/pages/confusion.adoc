...
penalties that turn. See the xref:movement.adoc#the-evade[Movement section] for
more details.
...
image::confusion/hammer-infantry.webp[width=2017,height=426,role=column-span]
...
.{empty}
image::confusion/moving-aside.svg[width=2772,height=1852,id=f-moving-aside]

image::confusion/troll.webp[width=807,height=483,role=decorative]
...
.{empty}
image::confusion/move-back.svg[width=1387,height=1856,id=f-move-back]
...
image::confusion/soldier-mace.webp[width=1057,height=1501,role=decorative]
