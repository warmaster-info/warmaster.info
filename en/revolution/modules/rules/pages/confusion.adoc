...
automatically confused. See xref:shooting.adoc#driving-back-enemies[driving back enemies] in the
...
section for details on xref:combat.adoc#retreats[retreats from combat].
+
...
. A confused infantry unit cannot support in combat.
  See the xref:combat.adoc#supporting-troops[Combat phase].
