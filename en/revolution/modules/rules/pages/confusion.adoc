...
image::confusion/hammer-infantry.webp[width=2017,height=426]
...
image::confusion/troll.webp[width=807,height=483]
...
image::confusion/soldier-mace.webp[width=1057,height=1501]
