...
formations of several stands [.ancients]#called *units*#.
...
image::game-values/infantry.webp[width=778,height=599]
...
image::game-values/cavalry-1.webp[width=947,height=799]

// Replace with a monster or artillery
// image::game-values/cavalry-2.webp[width=979,height=775]
...
found in the game, we assign three values to [.edit]#each
stand#. These are *Attacks*, *Hits* and *Armour*.

image::game-values/attacks-hits-armour.webp[width=726,height=522]
...
xref:command.adoc#orders[issuing orders]. Values vary from as low as 7 to as high as
...
More about command in xref:command.adoc[due course].
...
and characters having an appropriately higher value. xref:end-of-the-battle.adoc#victory-points[Once the
...
image::game-values/boar-riders.webp[width=2200,height=364]
...
////
// Warmaster Original text from further on in the Movement chapter:
...
.{empty}
image::game-values/line-of-sight-target.svg[width=1239,height=851,id=line-of-sight-target]
...
.{empty}
image::game-values/line-of-sight-blocked.svg[width=1239,height=851,id=line-of-sight-blocked]
...
.{empty}
image::game-values/line-of-sight-360.svg[width=1239,height=851,id=line-of-sight-360]
...
blocks line of sight as described in the xref:movement.adoc#terrain[Movement rules].
...
.{empty}
image::game-values/line-of-sight-terrain.svg[width=1239,height=851,id=line-of-sight-terrain]

[.qa]
[TIP]
====
The Q&A has a xref:questions-and-answers.adoc#line-of-sight-questions[section on Line of Sight] with further examples.
====

////
// This is in Ancients and Bo5A, but seems to conflict with
// flying units being able to see 100cm (at least) for their move.
...
image::game-values/goblins-advance.webp[width=2053,height=2989,role=column-span]
