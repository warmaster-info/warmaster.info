...
start of the Command phase can choose to move
...
may change orientation along the way. Flyers cannot
...
// Half-pace being 10cm is otherwise only in the Movement section.
Flying units move up to 100cm when moving under
orders. However when charging, flyers can move only
up to 60cm.
[.edit]#A flying unit’s half pace move is 10cm.#

Once a flying unit has moved, it is treated
...
[.edit]#move only# *half pace* (up to 10cm) when charging from
irregular formation which is an exception to the normal
rules.

image::flying-units/carpet.webp[width=737,height=733,role=decorative]
...
// NB more detail in Bo5A, differences with terrain.

image::flying-units/sorceress.webp[width=447,height=459,role=decorative]
...
treated exactly like ground troops – friends can
...
Combat phase are treated [.bo5a]#as described under <<moving>>#
...
.Optional rule
****
*Cautious Descent:* In the Command phase, flying
units must end their movement more than 1cm
away from enemy units unless charging.
****

image::flying-units/elf.webp[width=1875,height=2880,role=decorative]
