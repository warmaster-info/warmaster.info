...
described in the xref:shooting.adoc[Shooting section].
...
sight, as explained in the xref:characters.adoc[Generals, Wizards
and Heroes section].
...
as described in the xref:shooting.adoc#removing-casualties[Shooting phase section]. This
