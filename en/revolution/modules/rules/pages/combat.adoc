...
[TIP]
====
The Q&A has a xref:questions-and-answers.adoc#combat-questions[section on Combat] with further examples, including a xref:questions-and-answers.adoc#wrapping-pursuit[detailed example with diagrams] showing a full combat sequence.
====
