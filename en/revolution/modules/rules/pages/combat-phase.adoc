...
described in the xref:the-shooting-phase.adoc[Shooting section].
...
sight, as explained in the xref:generals-wizards-and-heroes.adoc[Generals, Wizards
and Heroes section].
...
as described in the xref:the-shooting-phase.adoc#removing-casualties[Shooting phase section]. This
...
existing one. See <<pursuit-and-destroyed-enemy>>.
--
****
