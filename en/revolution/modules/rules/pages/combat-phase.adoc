...
image::combat-phase/interlinked-engagement.png[id=f-interlinked-engagement]
...
.{empty}
image::combat-phase/pinned-target.png[id=f-pinned-target]
...
image::combat-phase/battle-view.png[id=battle-view]
