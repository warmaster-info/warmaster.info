...
Most of the text on this website is copied verbatim from the https://drive.google.com/file/d/1E2YTPKjGeF871Bj7aGaSF1uIlV2domk6/view?usp=sharing[WMR Compendium version 2.1.0] and https://drive.google.com/file/d/1jS81OufTxnx-W850E66LboTVSGQEokoN/view?usp=sharing[WMR Armies version 2.26], available from the https://www.wm-revolution.com/articles/download.html[Warmaster Revolution website].
...
Updating the Rulebook to the 2026 release, 2.1.0, is in progress.  The Siege & Fortresses section is not yet updated.

The Armies book is updated to the 2026 release (2.26).

[#feedback]
=== Corrections and suggestions

Feedback about this website is welcome on GitHub (https://github.com/warmaster-info/warmaster.info/issues[Rulebook, Armies and Battle of Five Armies sections], https://github.com/warmaster-info/wmr-experimental/issues[Experimental sections], https://github.com/warmaster-info/wmr-resources/issues[Resources section]), on the https://discord.gg/GucGtWNaYm[Warmaster Revolution Discord], or by email to {email}.
...
If you are interested in translating the website to your language, or would like to suggest improvements to the existing translations, please join the _#international-translation-helpline_ channel on the https://discord.gg/GucGtWNaYm[Warmaster Revolution Discord], or contact me by email at {email}.
