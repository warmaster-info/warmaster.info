...
the xref:revolution:armies:index.adoc[Army Lists].
...
means that you will have fewer points for other troops.

Magic items cannot be given to monsters, [.edit]#artillery,# machines
or flying units. Some items can only be given to characters
or to a Wizard as described later.
...
damage – a xref:revolution:armies:empire.adoc#ball-of-flame[Ball of Flame] inflicts 3 shooting attacks for
example but all 3 might fail to score hits or hits might be
nullified by armour.

There are some situations where the target of a spell is
not literally a unit – for example the xref:revolution:armies:empire.adoc#ball-of-flame[Ball of Flame] and
xref:revolution:armies:orcs.adoc#gotcha[Gotcha] spells inflict shooting attacks upon all units
...
be cast upon a unit any number of times, blasting
...
augment conventional tactics and weaponry but not form
...
with the same destructive spell cast over and over again.
...
// Moved earlier
image::magic/witch.webp[width=465,height=573,role=decorative]
...
[.cost]#Cost – superior (units with 5 or more Attacks when charging)# [.points]#30 pts#

[.cost]#Cost – major (units with 3 Attacks only)# [.points]#20 pts#

[.cost]#Cost – minor (units with 2 Attacks only)# [.points]#15 pts#

A unit with this banner increases the close combat Attacks
value of each of its stands by +1. Every time a stand of the unit is
removed roll a dice. On a roll of 1, 2 or 3 the banner is lost.

[#banner-of-shielding]
==== The Banner of Shielding

[.cost]#Cost – major (units with 5+ Armour only)# [.points]#30 pts#

[.cost]#Cost – minor (units with 6+ or 0 Armour only)# [.points]#20 pts#

A unit with this banner has its Armour increased in
effectiveness by \+1. If the unit’s Armour is 5+ then this banner
increases it to 4+ and so on. Every time a stand of the unit is
removed roll a dice. On the roll of 1, 2 or 3 the banner is lost.

[#banner-of-fortitude]
==== The Banner of Fortitude

[.cost]#Cost – (units with 3 Hits only)# [.points]#30 pts#

A unit with this banner increases the Hit of each of its stands
by +1. Every time a stand of the unit is removed roll a dice. On
the roll of 1, 2 or 3 the banner is lost.

[#banner-of-steadfastness]
==== The Banner of Steadfastness

[.cost]#Cost – superior (units with 4+ Armour only)# [.points]#15 pts#

[.cost]#Cost – major (units with 5+ Armour only)# [.points]#10 pts#

[.cost]#Cost – minor (units with 6+ or 0 Armour only)# [.points]#5 pts#
...
spells inflicted in the Shooting phase. Every time a stand of the
unit is removed roll a dice. On the roll of 1, 2 or 3 the banner
is lost.

[#banner-of-fortune]
==== The Banner of Fortune

[.cost]#Cost – superior (units with 5 or more Attacks when charging)# [.points]#15 pts#

[.cost]#Cost – major (units with 3 Attacks only)# [.points]#10 pts#

[.cost]#Cost – minor (units with 2 Attacks only)# [.points]#5 pts#
...
image::magic/boar-riders.webp[width=2195,height=386,role=column-span]
...
The Orb of Majesty cannot be used by Dark Elf or High Elf generals.
...
A Wizard with this ring is able to cast a spell on the roll of 2+. This item
will only work once in the entire game and when used it cannot be
combined with any other item granting a spell-casting bonus.
...
[.cost]#General only# [.points]#20 pts#
...
The Sceptre of Sovreignty cannot be used by Dark Elf or High Elf generals.
...
automatically cause an enemy’s spell to fail a the roll of 2+. The Scroll can only
be used once to nullify the effect of a spell an enemy Wizard has
successfully cast. In the case of a Runesmith, the Scroll can be used
after a normal Dwarf anti-magic roll has failed.
...
may cast another spell. He can only do this once during the entire game.
It does not matter if the previous spell is dispelled or anti-magicked
by a Runesmith so long as the required dice score was rolled.
After any effects of the previous spell have been resolved, the Wizard
...
be cast upon the same unit if the previous spell has been dispelled/anti-magicked.
This next spell is cast exactly like any other – roll a dice
to determine if it works in the usual way.

// As far as I can see, only Teleport allows casting a second spell
// Teleport followed by Teleport seems useless so I've concentrated
// the wording on the useful combinations.

[.edit]
The xref:revolution:armies:empire.adoc#teleport[Teleport] spell already allows the Wizard to cast a second, different spell.
The Rod of Repetition may be used after the second spell has been successfully cast.
If it is used to cast Teleport again then the bonus spell is lost.
This effectively restricts casting to a maximum of 3 spells
per turn.

[.edit]
Assuming successful casting the possibilities are:

[.edit]
* Teleport → second spell → Rod of Repetition for a third spell (which could be another Teleport), or
* First spell (could be Teleport) → Rod of Repetition to cast Teleport → third spell.

image::magic/mortar.webp[width=828,height=543,role=decorative]

image::magic/dwarf-runesmith.webp[width=2180,height=3040,role=column-span]
