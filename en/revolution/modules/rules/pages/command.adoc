...
a unit can use its own initiative to either charge or
evade from the *closest visible enemy unit* within 20cm (see xref:game-values.adoc#visibility-on-the-battlefield[Visibility on the battlefield]).
...
received its order and can move full pace (see xref::movement.adoc[Movement] [.edit]#for distances#). If the score
