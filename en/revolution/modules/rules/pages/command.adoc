...
xref:movement.adoc#the-path-of-evaders[evade] from the *closest xref:visible enemy unit* within 20cm (see xref:game-values.adoc#visibility-on-the-battlefield[Visibility on the battlefield]).
