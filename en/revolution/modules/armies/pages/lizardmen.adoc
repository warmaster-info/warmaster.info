...
:page-role: armylist page=27
:page-toclevels: 1
//po4a: entry skinks
//po4a: entry saurus
//po4a: entry temple-guard
//po4a: entry salamanders
//po4a: entry kroxigor
//po4a: entry cold-one-riders
//po4a: entry terradons
//po4a: entry stegadon
//po4a: entry slann-mage-palanquin
//po4a: entry saurus-hero
//po4a: entry skink-hero
//po4a: entry skink-shaman
//po4a: entry stegadon-mount
//po4a: entry carnosaur
:skinks: Skinks
:saurus: Saurus
...
:terradons: Terradons
:stegadon: Stegadon
:slann-mage-palanquin: Slann Mage Palanquin
:saurus-hero: Saurus Hero
:skink-hero: Skink Hero
:skink-shaman: Skink Shaman
:stegadon-mount: Stegadon Mount
:carnosaur: Carnosaur
:shoot-360-15cm: {skinks}
:shoot-360-15cm_b: Terradon riders
:shoot-360-15cm_c: The Stegadon’s crew
include::partial$table-attributes.adoc[]

image:lizardmen/logo.webp[width=99,height=92,float="right"]
...
races. In that distant age the planet was dominated by cold-blooded
creatures. The undisputed rulers of the world were
...
image::lizardmen/lizardmen.webp[width=2075,height=696]
...
[[reptilian,†2]]2. Reptilian:: Reptilian troops can only be issued an order by a
...
a –1 penalty when hit by Salamander Venom (e.g. 5+ save
...
[[terradon,†4]]4. Terradon:: Terradons can fly.
+
include::partial$shoot-360-15cm_b.adoc[]

[[stegadon,†5]]5. Stegadon:: As the Stegadon is so gargantuan, it uses a 40 x
...
Stegadons.
+
include::partial$shoot-360-15cm_c.adoc[]
+
...
[[slann-mage,†6]]6. Slann Mage:: The Slann Mage rides a palanquin carried by
...
Guidance – deducting −1 from his dice score (e.g. 8 counts as 7,
...
[[stegadon-mount,†7]]7. Stegadon Mount:: The Slann Mage may ride on top of a
...
[[carnosaur,†8]]8. Carnosaur:: A Saurus Hero can ride a Carnosaur. If a
character rides a Carnosaur then any unit he joins will cause
terror. No other character can ride a Carnosaur.

image::lizardmen/slann.webp[width=1065,height=1601,role=decorative]
...
_Burning jade-coloured rays leap from the Shaman’s lidded eyes
...
_An eerie aura surrounds the Shaman and his companions lifting
...
Shaman has joined. The spell affects only a single unit, never a
brigade and there is no supporting charge possible.

The unit can be moved just as if it had received an order in the
Command phase. The Shaman is moved together with the unit
...
combat and which is within range. The Shaman does not have
