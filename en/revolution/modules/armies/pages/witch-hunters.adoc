...
:page-role: armylist page=61
:page-toclevels: 1
//po4a: entry zealots
//po4a: entry halberdiers
//po4a: entry crossbowmen
//po4a: entry handgunners
//po4a: entry flagellants
//po4a: entry warhounds
//po4a: entry knights
//po4a: entry pistoliers
//po4a: entry cannon
//po4a: entry general
//po4a: entry hero
//po4a: entry warrior-priest
//po4a: entry war-altar
:zealots: Zealots
...
Zealots of the Witch Hunters’ guild stand shoulder-to-shoulder
with peasants and hastily gathered watchmen. Packs
...
image::witch-hunters/witch-hunters.webp[width=3497,height=1461]
...
The abilities of some units in the Witch Hunter army will
affect ‘Chaos and/or Undead’. ‘Chaos’ means the Chaos army,
Daemons army, Beastmen army, Chaos Dwarf army and
Skaven army. ‘Undead’ means the Tomb Kings army and Vampire
Counts army (including units of Ghouls!).
...
////
[[zealots,†1]]1. Zealots:: Zealots form the main part of a Witch Hunter army,
and are drawn from mobs whipped up by priest’ sermons.
These troops gain +1 Attack in the first round of combat
against Undead or Chaos (regardless of who charged) and will
always use their initiative to charge these enemies if possible.
+
If
victorious in combat with Undead or Chaos-like enemies they
must pursue or advance where possible.

[[handgunners,†2]]2. Handgunners:: Count enemy Armour values as one worse
...
[[flagellants,†3]]3. Flagellants:: So keen are they to meet their maker that a unit
...
[[warhounds,†4]]4. Warhounds:: Warhound stands are not deployed as
...
[[pistoliers,†5]]5. Pistoliers::
include::partial$shoot-360-15cm.adoc[]

[[cannons,†6]]6. Cannons:: See the rules for
xref:rules:artillery-and-machines.adoc#cannons[Cannons] in the Warmaster Rulebook.

[[war-altar,†7]]7. War Altar:: A Warrior Priest may be mounted on a War
Altar.
+
A Warrior Priest with a War Altar suffers a movement
reduction to 30cm.
+
The army can only ever include one War
Altar, and it can only be included if there is at least 1 unit
of Flagellants in the army.
+
The War Altar adds +2 attacks to
the Warrior Priest and can be used to add +1 to the Warrior
Priest’s dice roll to cast a spell once per battle. The player must
announce that the War Altar‘s spell bonus is being used before
rolling the dice to determine if the spell is cast.

image::witch-hunters/pistoliers.webp[width=1040,height=645,role=decorative]
...
The Warrior Priest must be with the unit to affect it. The unit counts
...
The Warrior Priest must be with the unit to affect it. If successfully
...
image::witch-hunters/witch-hunters-battle.jpg[width=2200,height=1500,role=column-span]
