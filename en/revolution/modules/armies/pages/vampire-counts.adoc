...
:page-role: armylist page=42
:page-toclevels: 1
//po4a: entry skeletons
//po4a: entry zombies
//po4a: entry ghouls
//po4a: entry grave-guard
//po4a: entry ethereal-host
//po4a: entry black-knights
//po4a: entry dire-wolves
//po4a: entry fell-bats
//po4a: entry vampire-lord
//po4a: entry vampire
//po4a: entry necromancer
//po4a: entry winged-nightmare
//po4a: entry black-coach
:skeletons: Skeletons
:zombies: Zombies
:ghouls: Ghouls
:grave-guard: Grave Guard
:ethereal-host: Ethereal Host
...
:winged-nightmare: Winged Nightmare
...
known as the Age of Three Emperors when all centralised
...
image::vampire-counts/vampire-counts.webp[width=2078,height=822]
...
Fell Bats which can ‘home back’ as noted below). This also means an
...
[[ethereal-host,†1]]1. Ethereal Host:: Ethereal Host Attacks always inflict a hit on
...
or don’t count depending on status).
+
Ethereal hosts cannot be
driven back by shooting and do not roll for drive backs.
+
They
cause terror as described in the Warmaster rulebook.
+
Ethereal
Hosts cannot have magic items.

[[dire-wolves,†2]]2. Dire Wolves:: If the unit charges against an enemy in the open
it receives an additional +1 Attack modifier in the same way as
chariots and monsters.
+
Dire Wolves cannot have magic items.

[[fell-bats,†3]]3. Fell Bats:: Fell Bats can fly.
+
Although they cannot use initiative
they are allowed to xref:rules:flying-units.adoc#home-back[home back] as described in the Warmaster
rulebook. No order is required to home back.
+
Fell Bats are an
...
[[vampire-lord,†4]]4. Vampire Lord:: A Vampire Lord is a powerful sorcerers as well as the
army’s general. He can cast spells in the same way as a Wizard
...
[[winged-nightmare,†5]]5. Winged Nightmare:: Any character can ride a Winged
Nightmare.
+
A Winged Nightmare can fly increasing its rider’s
move to 100cm and adding +2 to its rider’s attacks.
+
A unit joined
by a character riding a Winged Nightmare causes terror in its enemies.

[[black-coach,†6]]6. Black Coach:: A Vampire Lord or Vampire can be mounted
within a Black Coach adding +1 to its occupant’s attacks.
+
A unit
joined by a character riding in the Black Coach causes terror in
its enemies.

image::vampire-counts/nightmare.webp[width=816,height=1020,role=decorative]
...
engagement or not. A single combat engagement only can be
...
are as they appear when the dice to cast the spell is rolled: so it
...
image::vampire-counts/skeletons.webp[width=2079,height=1139,role=column-span]
