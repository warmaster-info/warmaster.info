...
:page-role: armylist page=33
:page-toclevels: 1
//po4a: entry winged-lancers
//po4a: entry horse-archers
//po4a: entry cossacks
//po4a: entry bowmen
//po4a: entry red-guard
//po4a: entry axemen
//po4a: entry bears
//po4a: entry war-wagon
//po4a: entry general
//po4a: entry hero
//po4a: entry shaman
//po4a: entry bear
...
:yozhin: Yozhin
:tzarina: Tzarina
:shoot-360-15cm: Kislevite Horsemen
...
image::kislev/kislev.webp[width=1363,height=784]
...
[[winged-lancers,†1]]1. Winged Lancers:: Winged Lancers receive +1 Attack in the
first round of every combat when fighting to the front and are
Immune to Terror.

[[horse-archers-cossacks,†2]]2. Horse Archers, Cossacks::
include::partial$shoot-360-15cm.adoc[]

[[bowmen,†3]]3. Bowmen:: One unit of Bowmen per full 1000 points can
replace a unit of Axemen while still counting for Axemen min/max
value.

[[red-guard,†4]]4. Red Guard:: In addition to traditional Kislevite long axes Red
Guard are armed with handguns. Count enemy armour values as
...
[[bears,†5]]5. Bears:: Bears are defined as infantry for rules purposes as
...
riding a Bear or Shamans that have transformed in Monster
Bear.

[[war-wagon,†6]]6. War Wagon:: image:kislev/wagon-laagered.webp[width=250,height=253,float="right"]{empty}
War Wagon. The War Wagon consists of a wagon stand
and a horse team stand. The unit must always be in one of
two formations: a column with the horse team in front of the
wagon, or a laager with the horse team placed beside the wagon
edge to edge.
+
The War Wagon cannot charge and moves 20cm at full pace. A
War Wagon unit moving more than 5cm must end its move in a
column formation. After a successful order, if at least one stand
moves no more than 5cm, the unit may end its move in laager
formation. The War Wagon may enter laager formation as part
of an evade, following the 5cm movement restriction.
+
Uniquely, the War Wagon attacks are shared between the
stands: a total of 4 melee attacks that can be directed from
either the horse team or wagon stand and a total of 4 shooting
attacks with 360° vison. Count enemy armour values as one
worse than normal when shot by a War Wagon.
+
A War Wagon in column formation cannot
pursue. Unlike other artillery it can retreat
from combat and is not destroyed if forced
to do so.
+
A War Wagon in laager formation counts
as a defended unit, with no sides or rear.
It cannot make way. It cannot be driven
...
A War Wagon in laager formation will neither pursue nor
retreat. If obliged to retreat, it instead remains in place, is not
destroyed, continues to count as defended, and enemy stands do
not receive any pursuit bonuses against it in subsequent rounds
of combat.
+
Either stand can be removed as causality. If the horse team stand
is removed, the wagon stand will count as in laager formation
for the remainder of the game. If the wagon stand is removed,
the remaining horse team stand has no armour, no attacks, and
counts as in column formation.
+
...
[[bear-mount,†7]]7. Bear Mount:: Generals, Heroes and Shamans can ride a Bear
mount. The Bear adds +1 Attack to that of its rider.

[[yozhin,†8]]8. Yozhin:: This creature has lived in swamps near Praag since
the great incursion of Chaos. Yozhin strongly hates any kind
of Chaos, being (possibly) a Chaos-twisted creature itself. Only
powerful Shamans may summon Yozhin and make it fight
on their side. A single Shaman in the army can be assisted by
Yozhin.
+
[.edit]#Yozhin may enter water, bogs or swamps without restriction.#
+
A unit that has been joined by [.edit]#a Shaman riding Yozhin#
causes terror in its enemies.
+
Yozhin adds +1
Attack to Shaman’s attacks value.

[[tzarina,†9]]9. Tzarina:: The General may be a Tzarina of the royal blood –
perhaps Tzarina Katrina herself. The Tzarina rides a horse-drawn
sled – note this is not a chariot!
+
The Tzarina can cast
spells like a Wizard and can carry a magic item restricted to a
Wizard if desired.
+
Once during the battle the Tzarina can add
...
image::kislev/general.webp[width=751,height=789,role=decorative]
...
image::kislev/war-wagon.webp[width=1359,height=959,role=decorative]
