...
replace a unit of Axemen while still counting for Axemen min/
max value.
...
Yozhin. There is no restriction for going into any water/boggy/
swamp terrain for him. A unit that has been joined by a Yozhin
