...
:cathay: Cathay
:nippon: Nippon
:shoot-360-15cm: Units with Throwing Weapons
...
// Around → amongst,
// fonly → only, of course if → assuming
Amongst them some are more recognisable than others, mostly
by the name of their leader. In the land of Tilea – traditional
home of mercenaries – the greatest formations have become
Regiments of Renown. They are the most skilled, accomplished
and noble mercenaries affordable only by the wealthiest leaders
such as kings, princes and mighty warlords. Sometimes they
may be hired even by a Dogs of War leader, assuming he can
pay enough. In the restless Old World they usually have much
work on their hands.
...
included in the Regiments of Renown unit profile). They also receive a +1 bonus
...
other troops. That means one roll for your army list troops and
one roll for Regiments of Renown troops.
+
They may not be targeted by friendly Wizard’s spells and do
...
roll a dice and decide who got the ‘authentic’ one and who the
...
+
image::regiments-of-renown/asarnil-dragonlord.webp[width=927,height=833]
...
[[throwing-weapons,†3]]3. Throwing weapons::
