...
:page-role: armylist page=30
:page-toclevels: 1
//po4a: entry bowmen
//po4a: entry men-at-arms
//po4a: entry peasants
//po4a: entry squires
//po4a: entry knights
//po4a: entry grail-knights
//po4a: entry pegasus-knights
//po4a: entry trebuchet
//po4a: entry general
//po4a: entry hero
//po4a: entry enchantress
//po4a: entry unicorn
//po4a: entry pegasus
//po4a: entry hippogriff
//po4a: entry grail-reliquae
:bowmen: Bowmen
:men-at-arms: Men-at-arms
:peasants: Peasants
:squires: Squires
:knights: Knights
:grail-knights: Grail Knights
...
their heroism, taking priority over lesser Knights and earning
...
image::bretonnia/bretonnia.webp[width=2075,height=918]
...
[[peasants,†1]]1. Peasants:: A unit of Peasants suffers an additional −1 Command
...
[[knights,†2]]2. Knights:: A Knight unit will always use its initiative to charge
...
[[grail-knights,†3]]3. Grail Knights:: If the unit of Grail Knights is charging against
an enemy in the open it receives an additional +1 Attack
modifier in the same way as chariots and monsters.

[[pegasus-knights,†4]]4. Pegasus Knights:: Pegasus Knights can fly.

[[trebuchet,†5]]5. Trebuchet:: The Bretonnian Trebuchet is one of the mightiest
and most excellent stone throwers that are built in the Old
World. At first it was designed to help the noble knights with
the occasional and messy sieges that had to be done
but later was adjusted to be used in field battles too. As the
Trebuchet is so gargantuan, it uses a 40 × 60mm base, with the
...
[[unicorn,†6]]6. Unicorn:: Only an Enchantress can ride a Unicorn. The
...
[[pegasus,†7]]7. Pegasus:: The Pegasus can be ridden by a General, Hero or
Enchantress and adds +1 Attack to the rider as well as allowing
the character to fly.

[[hippogriff,†8]]8. Hippogriff:: A single General or Hero can ride a Hippogriff.
+
A Hippogriff can fly, increasing its rider’s move from 60 to 100cm,
and it adds +2 Attacks to those of its rider.
+
A unit that includes
a Hippogriff rider causes terror in its enemies.

[[grail-reliquae,†9]]9. Grail Reliquae:: This sacred item can be given to one unit
...
image::bretonnia/green-knight.webp[width=419,height=585,role=decorative]
...
image::bretonnia/knights.jpg[width=1520,height=763,role=column-span]
