...
:page-role: armylist page=58
:page-toclevels: 1
//po4a: entry goblins
//po4a: entry squig-herd
//po4a: entry trolls
//po4a: entry wolf-riders
//po4a: entry wolf-chariots
//po4a: entry pump-wagon
//po4a: entry giant
//po4a: entry doom-diver
//po4a: entry spear-chukka
//po4a: entry goblin-warboss
//po4a: entry goblin-hero
//po4a: entry goblin-shaman
//po4a: entry wolf-chariot
//po4a: entry wyvern
:goblins: Goblins
:squig-herd: Squig Herd
:trolls: Trolls
:wolf-riders: Wolf Riders
:wolf-chariots: Wolf Chariots
:pump-wagon: Pump Wagon
:giant: Giant
:doom-diver: Doom Diver
:spear-chukka: Spear Chukka
:goblin-warboss: Goblin Warboss
:goblin-hero: Goblin Hero
:goblin-shaman: Goblin Shaman
:wolf-chariot: Wolf Chariot
:wyvern: Wyvern
...
image::goblins/goblins.webp[width=2180,height=1071]
...
////
1: Squig Herds, min/max note removed as there isn't a min/max.
2: Paragraph added
3: its
4: add "the", combat phase, deals, "it charges, pursuits or advances," seem extra TODO
   Reworded anyway.
////
...
[[wolf-riders,†3]]3. Wolf Riders:: The Wolf Riders have a shooting range of 15cm
...
[[pump-wagon,†4]]4. Pump Wagon:: The Pump Wagon doesn’t move in the Command
phase by initiative or by successful orders. Instead it
always moves once up to 1D6 × 10cm. This move is automatic,
requires no Command roll, and happens at any time during
...
each turn.
+
In the combat [.edit]#phase# a
Pump Wagon [.edit]#deals# D6 attacks. This is in addition to any
[.edit]#attack bonuses# for charging enemy in the open
...
Pump Wagons, and characters cannot join it.
+
The enemy does
...
[[doom-diver,†6]]6. Doom Diver:: The Doom Diver has a range of 60cm and a unit
...
[[spear-chukka,†7]]7. Spear Chukka:: The Spear Chukka is a xref:rules:artillery-and-machines.adoc#bolt-thrower[Bolt Thrower].

[[wolf-chariot,†8]]8. Wolf Chariot:: [.edit]#Any character# can ride a Wolf
Chariot.
+
The character riding a chariot adds +1 to his Attacks.

[[wyvern,†9]]9. Wyvern:: [.edit]#Any# characters may ride a Wyvern.
+
A Wyvern can fly
increasing its rider’s movement from 60cm to 100cm, and it
adds +2 Attacks to those of its rider.
+
A unit that includes a
Wyvern rider causes terror in its enemies.

image::goblins/wolf-riders.webp[width=729,height=310,role=column-span]
...
image::goblins/pump-wagons.webp[width=1919,height=656,role=column-span]
