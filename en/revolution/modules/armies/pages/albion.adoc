...
:page-role: armylist page=55
:page-toclevels: 1
//po4a: entry warriors
//po4a: entry slingers
//po4a: entry ogres
//po4a: entry wolfhounds
//po4a: entry riders
//po4a: entry chariots
//po4a: entry giant
//po4a: entry giant-eagles
//po4a: entry fenbeast
//po4a: entry general
//po4a: entry hero
//po4a: entry druid
//po4a: entry giant-eagle
//po4a: entry chariot
:warriors: Warriors
:slingers: Slingers
:ogres: Ogres
...
circles and thousands of miles of impressively taut leylines once
...
of greatness when their ancestors helped build the stone circles
and other wonders that once formed the nerve centre of the
Slanns’ techo-arcane warp mechanism.

// remove "of Albion", extra .
...
image::albion/albion.webp[width=2129,height=1082,role=column-span]
...
////
[[ogres,†1]]1. Ogres:: If an Ogre unit can use its initiative to charge an enemy
...
[[giant-eagles,†3]]3. Giant Eagles:: Giant Eagles can fly.

[[giant-eagle-mount,†4]]4. Giant Eagle Mount:: Giant Eagles can be ridden by Druids only.
+
An Eagle can fly, increasing its rider’s move from 60 to
100cm.
+
It adds +2 Attacks to those of its rider.

[[chariot-mount,†5]]5. Chariot Mount:: Generals, Druids and Heroes can ride
Chariots.
+
An extra +1 Attack is added to those of its rider.

[[fenbeast,†6]]6. Fenbeast:: A Fenbeast is an individual troop unit, but it is not
fielded in the standard way. Fenbeast can
...
The spell is cast upon the Druid himself and affects all enemy
units within 30cm of the stand. The spell lasts until the end
of the opposing player’s following turn. The spell affects the
opposing army’s ability to issue commands.

All enemy units within 30cm of the Druid suffer a −1 Command
penalty. This penalty is applied when each order is issued: a
unit might therefore be within 30cm of the Druid for one order
but not for a second, for example.
...
Infantry unit counts as Defended, even if in open terrain.
...
image::albion/druid.webp[width=631,height=839,role=decorative]
