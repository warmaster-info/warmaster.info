...
:page-role: armylist page=21
:page-toclevels: 1
//po4a: entry warriors
//po4a: entry miners
//po4a: entry handgunners
//po4a: entry rangers
//po4a: entry troll-slayers
//po4a: entry cannon
//po4a: entry flame-cannon
//po4a: entry gyrocopter
//po4a: entry general
//po4a: entry hero
//po4a: entry runesmith
//po4a: entry anvil
:warriors: Warriors
:miners: Miners
:handgunners: Handgunners
:rangers: Rangers
:troll-slayers: Troll Slayers
:cannon: Cannon
...
:runesmith: Runesmith
:anvil: Anvil
:infiltration-unit: {rangers}
include::partial$table-attributes.adoc[]

image:dwarfs/logo.webp[width=109,height=109,float="right"]
...
Dwarf taste, which they consider to be extraordinarily gaudy
and vulgar.
...
image::dwarfs/anvil.webp[width=761,height=1230]
...
[[handgunners,†1]]1. Handgunners:: A handgun shot can pierce armour far more
...
[[rangers,†2]]2. Rangers:: One unit of Rangers per full 1000 points does not
...
[[troll-slayers,†3]]3. Troll Slayers:: A Troll Slayer unit will always use its initiative
...
--
+
Troll Slayer units that have been destroyed still count towards
the Dwarf army’s losses for purposes of calculating withdrawal.

[[cannon,†4]]4. Cannon:: Full rules for xref:rules:artillery-and-machines.adoc#cannons[Cannons] are in the main Rulebook.

[[flame-cannon,†5]]5. Flame Cannon:: The Flame Cannon is an infernal device that
...
[[gyrocopter,†6]]6. Gyrocopter:: The Gyrocopter is a flying machine, so all the
...
[[hero,†7]]7. Hero:: One Hero in the army may be upgraded to carry
an Oathstone for +15 pts. Once per game, the Hero may use
the Oathstone to inspire one unit that he has joined (except
Troll Slayers). Both the Hero, and the unit he has joined, gain
+1 attack per stand, and are immune to Terror, until the end of
the combat phase.

[[runesmith,†8]]8. Runesmith:: Although they are not Wizards and cannot
therefore cast spells, Dwarf Runesmiths can combat the magic
of their enemies. If an enemy Wizard who is within 50cm of
the Runesmith casts a spell the Runesmith can attempt to anti-magic
it. Note that it does not matter what the spell is or where
...
[[anvil,†9]]9. Anvil:: The army can only include a single anvil and it is
...
image::dwarfs/miner.jpg[width=612,height=697,role=column-span]
