...
:page-role: armylist page=12
:page-toclevels: 1
//po4a: entry chaos-warriors
//po4a: entry chaos-marauders
//po4a: entry ogres
//po4a: entry trolls
//po4a: entry marauder-horsemen
//po4a: entry chaos-knights
//po4a: entry chaos-hounds
//po4a: entry chaos-chariots
//po4a: entry harpies
...
can be divided into three main groups – the towering flaxen-haired
Norse, the raven-haired and dark-skinned Kurgan, and
...
They are tough bloodthirsty barbarians at heart, but they are
...
image::chaos/chaos.webp[width=2462,height=1555]
...
[[harpies,†3]]3. Harpies:: Harpies are based facing the long edge of the base in
...
[[spawn,†5]]5. Spawn:: Spawn units have −1 Command penalty if not part
...
[[chaos-dragon,†6]]6. Chaos Dragon:: Generals, Wizards and Heroes can ride a
Chaos Dragon.
+
include::partial$dragon.adoc[]

[[chariot-mount,†7]]7. Chariot Mount:: Generals, Sorcerers and Heroes can ride
Chariots. An extra +1 Attack is added to those of its rider.

image::chaos/warriors.webp[width=1962,height=650,role=column-span]
...
_An arc of pure energy strikes the foe, wreaking monstrous
changes, melting flesh and twisting bones into monstrous form._
...
image::chaos/knights.webp[width=1400,height=1027,role=decorative]
