...
accuracy. They add +1 to their dice roll when making shooting
...
// Spelling their, force → forth, form → from
_The Spell Weaver calls forth a mass of tangling branches to
...
// weird → eldritch, target unit → silent elves.
_An [.edit]#eldritch# enchantment forms around the [.edit]#silent elves#._

// next rearranged, magic → shooting
The target unit causes terror until the next Wood Elf [.edit]#Shooting# phase.
...
// Add "The [enemy] unit"
[.edit]#The target# unit may make a charge move into contact with the nearest
visible enemy unit in the same way as when charging. The enemy unit
may not shoot at the chargers.
...
[.edit]
_Trees shake, branches lash out and vines entangle the foe as
they approach the forest._

// Add "the", "the"
The spell makes three shooting attacks on all enemy units
within 10cm of the chosen wooded terrain piece. Units get no
armour save if within wooded terrain.
