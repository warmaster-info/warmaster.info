...
:page-role: armylist page=70
:page-toclevels: 1
//po4a: entry gor
//po4a: entry ungor
//po4a: entry bestigors
//po4a: entry minotaurs
//po4a: entry centigors
//po4a: entry chaos-hounds
//po4a: entry tuskgor-chariots
//po4a: entry dragon-ogres
//po4a: entry chaos-spawn
//po4a: entry dragon-ogre-shaggoth
//po4a: entry beastlord
//po4a: entry doombull
//po4a: entry wargor
//po4a: entry bray-shaman
//po4a: entry tuskgor-chariot
:gor: Gor
:ungor: Ungor
:bestigors: Bestigors
:minotaurs: Minotaurs
:centigors: Centigors
:chaos-hounds: Chaos Hounds
:tuskgor-chariots: Tuskgor Chariots
:dragon-ogres: Dragon Ogres
:chaos-spawn: Chaos Spawn
:dragon-ogre-shaggoth: Dragon Ogre Shaggoth
:beastlord: Beastlord
:doombull: Doombull
:wargor: Wargor
:bray-shaman: Bray Shaman
:tuskgor-chariot: Tuskgor Chariot
:shoot-360-15cm: {centigors}
...
image::beastmen/beastmen.webp[width=2079,height=622]
...
The Thing in the Woods:: Beastmen infantry do not suffer the
...
5: if not → unless
////
[[gor-ungor,†1]]1. Gor/Ungor:: Up to half the Gor units (rounded down) and
...
[[minotaurs,†2]]2. Minotaurs:: Minotaurs are subject to Bloodlust – they always
use initiative to charge if possible and cannot be given orders
instead. A unit with Bloodlust never uses initiative to evade and
must pursue or advance where possible.
+
Also, it is immune to
terror, cannot be driven back by shooting and never rolls for
drive backs.

[[centigors,†3]]3. Centigors::
include::partial$shoot-360-15cm.adoc[]

[[dragon-ogres,†4]]4. Dragon Ogres:: Dragon Ogres are immune to terror.

[[chaos-spawn,†5]]5. Chaos Spawn:: Spawn units have −1 Command penalty unless
...
[[dragon-ogre-shaggoth,†6]]6. Dragon Ogre Shaggoth:: Dragon Ogre Shaggoth must always
...
[[doombull,†7]]7. Doombull:: A unit joined by a Doombull cause terror. Also,
...
[[tuskgor-chariot,†8]]8. Tuskgor Chariot:: Beastlord or Wargors can ride a Tuskgor
Chariot. A character riding a chariot adds +1 to his Attacks.

image::beastmen/infantry.webp[width=2869,height=1050,role=column-span]
...
its Initiative. Any order given to the unit, or to any brigade of
...
The spell can be cast on an unengaged friendly unit within range
