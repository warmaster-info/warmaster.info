...
:page-role: armylist page=39
:page-toclevels: 1
//po4a: entry daemon-hordes
//po4a: entry daemon-swarm
//po4a: entry daemon-cavalry
//po4a: entry daemon-hounds
//po4a: entry daemon-chariots
//po4a: entry daemon-beasts
//po4a: entry daemon-flyers
//po4a: entry greater-daemon
//po4a: entry daemon-overlord
//po4a: entry daemon-lord-hero
//po4a: entry daemon-sorcerer
//po4a: entry daemonic-wings
//po4a: entry favour-of-the-gods
//po4a: entry chariot
//po4a: entry wizard-powers
:daemon-hordes: Daemon Hordes
:daemon-swarm: Daemon Swarm
:daemon-cavalry: Daemon Cavalry
:daemon-hounds: Daemon Hounds
:daemon-chariots: Daemon Chariots
:daemon-beasts: Daemon Beasts
:daemon-flyers: Daemon Flyers
:greater-daemon: Greater Daemon
:daemon-overlord: Daemon Overlord
:daemon-lord-hero: Daemon Lord Hero
:daemon-sorcerer: Daemon Sorcerer
:daemonic-wings: Daemonic Wings
:favour-of-the-gods: Favour of the Gods
:chariot: Chariot
...
image::daemons/daemons.webp[width=1779,height=969]
...
[[daemon-swarms,†1]]1. Daemon Swarms:: These cannot be driven back by shooting
and do not roll for drive backs.
+
A Daemon Swarm cannot be
given a magic item.

[[daemon-flyers,†2]]2. Daemon Flyers:: These can fly.
+
Daemon Flyers are an exception
...
[[greater-daemons,†3]]3. Greater Daemons:: Greater Daemons can fly regardless of
whether the actual model has wings – aerial propulsion is
deemed feasible by sheer effort of will.
+
Greater Daemons cause terror in their enemies.
+
A Greater
...
[[daemon-overlord,†4]]4. Daemon Overlord:: The Daemon Overlord is the army’s
...
[[daemonic-wings,†5]]5. Daemonic Wings:: Some of the creatures of the deep vaults
...
[[favour-of-the-gods,†6]]6. Favour of the Gods:: Demon Overlord, Lord Heroes or Sorcerers can
be given the Favour of the Gods. The character then gains +1
extra Attack and causes terror in its enemies as described in the
Warmaster rulebook.

[[chariot-mount,†7]]7. Chariot Mount:: Demon Overlords, Lord Heroes and Sorcerers can ride
Chariots. An extra +1 Attack is added to those of its rider.

image::daemons/infantry.webp[width=1336,height=744,role=decorative]
...
This spell can be cast on any friendly Daemon unit originally of three
...
image::daemons/greater-daemon.webp[width=1061,height=945,role=decorative]
