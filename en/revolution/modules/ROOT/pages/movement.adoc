...
in diagrams 21.1. and 21.2. For example, there must be
...
image::movement/move-through-gap.png[]
...
image::movement/cannot-move-through-gap.png[]
...
closest. See diagrams 23.1 and 23.2.
...
image::movement/initiative-charge-1.png[]
...
image::movement/initiative-charge-2.png[]
...
image::movement/evade-direction.png[]
...
ranks to allow the other to pass. See Diagram 24.2. This
obviously takes time, so a unit which is burst through is
automatically *confused*! See the Confusion section (p.55).

#TODO: fix diagram#

.The path of the evading unit takes it through an unengaged friendly unit. The unit that has been burst through becomes confused. This happens if the stands overlap as the evader moves, even if they do so only partially. Friendly unit is burst through and confused. Unit evades along path in line with closest stand. The two remaining stands are positioned as required to complete the evasion.
image::movement/evade-burst-through.png[]
